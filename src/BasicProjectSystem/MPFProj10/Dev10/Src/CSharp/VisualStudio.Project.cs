...
namespace Microsoft.VisualStudio.Project
{
	...
	internal sealed class SR
	{
		...
		internal SR()
		{
			...
			//resources = new System.Resources.ResourceManager("SimpleProjectPackage", this.GetType().Assembly);
			resources = SimpleProjectPackage.Properties.Resources.ResourceManager;
        }
